using Pastelaria.Repository.Infra.Extensions;  // Usando extensões específicas do projeto
using Pastelaria.Repository.Infra.HandledExceptions;  // Usando exceções personalizadas para tratamento
using System;
